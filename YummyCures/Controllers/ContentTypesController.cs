...
namespace YummyCures.Controllers
{
    public class ContentTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ContentTypeID,ContentTypeDescription")] ContentType contentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ContentTypeID,ContentTypeDescription")] ContentType contentType)
        {
            if (ModelState.IsValid)
            {
